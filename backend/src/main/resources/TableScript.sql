...
insert into Books values(5,"http://books.google.com/books/content?id=H_y_rJ7QdxgC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api","The Penguin Book of Romantic Poetry", 175, 19, "Romance", "Jonathan Wordsworth", "New" );
