...
const StandardBookUrl = "http://localhost:4001/BooksByKilo/StandardBooks";
...
export default class StandardCollection extends Component {
  ...
  under100 = () => {
    ...
    axios
      .get(booksBasedOnWeight.concat("/" + "Standard" + "/" + "hundred"))
      .then((response) => {
  ...
  Between100to200 = () => {
    ...
    axios
      .get(booksBasedOnWeight.concat("/" + "Standard" + "/" + "100TO200"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  Between200to500 = () => {
    ...
    axios
      .get(booksBasedOnWeight.concat("/" + "Standard" + "/" + "201TO500"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  over500 = () => {
    ...
    axios
      .get(booksBasedOnWeight.concat("/" + "Standard" + "/" + "Over500"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  price101to200 = () => {
    ...
    axios
      .get(booksBasedOnPrice.concat("/" + "Standard" + "/" + "100TO200"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  priceUnder100 = () => {
    ...
    axios
      .get(booksBasedOnPrice.concat("/" + "Standard" + "/" + "hundred"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  price201to500 = () => {
    ...
    axios
      .get(booksBasedOnPrice.concat("/" + "Standard" + "/" + "201TO500"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  priceAbove500 = () => {
    ...
    axios
      .get(booksBasedOnPrice.concat("/" + "Standard" + "/" + "Over500"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
