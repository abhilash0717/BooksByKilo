...
export default class PremiumCollection extends Component {
  ...
  under100 = () => {
    ...
    axios
      .get(booksBasedOnWeight.concat("/" + "Premium" + "/" + "hundred"))
      .then((response) => {
  ...
  Between100to200 = () => {
    ...
    axios
      .get(booksBasedOnWeight.concat("/" + "Premium" + "/" + "100TO200"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  Between200to500 = () => {
    ...
    axios
      .get(booksBasedOnWeight.concat("/" + "Premium" + "/" + "201TO500"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  over500 = () => {
    ...
    axios
      .get(booksBasedOnWeight.concat("/" + "Premium" + "/" + "Over500"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  price101to200 = () => {
    ...
    axios
      .get(booksBasedOnPrice.concat("/" + "Premium" + "/" + "100TO200"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  priceUnder100 = () => {
    ...
    axios
      .get(booksBasedOnPrice.concat("/" + "Premium" + "/" + "hundred"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  price201to500 = () => {
    ...
    axios
      .get(booksBasedOnPrice.concat("/" + "Premium" + "/" + "201TO500"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  priceAbove500 = () => {
    ...
    axios
      .get(booksBasedOnPrice.concat("/" + "Premium" + "/" + "Over500"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
