...
export default class NewBooks extends Component {
  ...
  under100 = () => {
    ...
    axios
      .get(booksBasedOnWeight.concat("/" + "New" + "/" + "hundred"))
      .then((response) => {
  ...
  Between100to200 = () => {
    ...
    axios
      .get(booksBasedOnWeight.concat("/" + "New" + "/" + "100TO200"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  Between200to500 = () => {
    ...
    axios
      .get(booksBasedOnWeight.concat("/" + "New" + "/" + "201TO500"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  over500 = () => {
    ...
    axios
      .get(booksBasedOnWeight.concat("/" + "New" + "/" + "Over500"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  price101to200 = () => {
    ...
    axios
      .get(booksBasedOnPrice.concat("/" + "New" + "/" + "100TO200"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  priceUnder100 = () => {
    ...
    axios
      .get(booksBasedOnPrice.concat("/" + "New" + "/" + "hundred"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  price201to500 = () => {
    ...
    axios
      .get(booksBasedOnPrice.concat("/" + "New" + "/" + "201TO500"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
  ...
  priceAbove500 = () => {
    ...
    axios
      .get(booksBasedOnPrice.concat("/" + "New" + "/" + "Over500"))
      .then((response) => {
        console.log(response.data);
        this.setState({ books: response.data });
      })
